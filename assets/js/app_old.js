...
/* Initialize Wheel */
wheel.initWheel([
  "imgsrc:images/circle-01.png",
  "imgsrc:images/circle-02.png",
  "imgsrc:images/circle-03.png",
  "imgsrc:images/circle-04.png",
...
var displayNodes0 = function() {
  orbitSVG.appendLine(1, "images/arc-01.svg", lineSize,linePosition);
  orbitSVG.appendBubble(0.8, "images/bubble-01-01.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(0.8,140,bubbleSize,bubblePosition,text_01_01);
  orbitSVG.appendBubble(1, "images/bubble-01-02.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(.98,45,bubbleSize,bubblePosition,text_01_02);

  orbitSVG.appendBubble(1.2, "images/bubble-01-03.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(1.2,110,bubbleSize,bubblePosition,text_01_03);
  orbitSVG.appendBlock(3,
  {
    href:"images/block-01.png",
    width:75,
    height:75
  },
  "images/line-01.svg","#fe921a",bubbleSize,bubblePosition,[110,110],text_01_block,2)
...
var displayNodes1 = function() {
  orbitSVG.appendLine(1, "images/arc-02.svg", longLineSize,linePosition);
  orbitSVG.appendBubble(0.75, "images/bubble-02-01.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(0.73,[135,80],bubbleSize,bubblePosition,text_02_01,2);
  orbitSVG.appendBubble(.91, "images/bubble-02-02.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(0.90,110,bubbleSize,bubblePosition,text_02_02);
  orbitSVG.appendBubble(1.08, "images/bubble-02-03.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(1.08,75,bubbleSize,bubblePosition,text_02_03);
  orbitSVG.appendBubble(1.25, "images/bubble-02-04.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(1.26,140,bubbleSize,bubblePosition,text_02_04);
  orbitSVG.appendBlock(3,
  {
    href:"images/block-02.png",
    width:70,
    height:70
  },
  "images/line-02.svg","#31a879",bubbleSize,bubblePosition,[42,130],text_02_block,2)
};


var displayNodes2 = function() {
  orbitSVG.appendLine(1.34, "images/arc-03.svg", bottomLineSize,linePosition);
  orbitSVG.appendBubble(1.2, "images/bubble-03-01.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(1.2,160,bubbleSize,bubblePosition,text_03_01);
  orbitSVG.appendBubble(1.4, "images/bubble-03-02.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  ...
  orbitSVG.appendBlock(3,
  {
    href:"images/block-03.png",
    width:85,
    height:85
  }
  ,"images/line-03.svg","#229fb8",bubbleSize,bubblePosition,[115,135],text_03_block,2)
};
...
var displayNodes3 = function() {
  orbitSVG.appendLine(3, "images/arc-04.svg", longLineSize,linePosition);
  orbitSVG.appendBubble(3.2, "images/bubble-04-01.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(3.22,[90,160],bubbleSize,bubblePosition,text_04_01,2);
  orbitSVG.appendBubble(3, "images/bubble-04-02.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(3.01,[95,110],bubbleSize,bubblePosition,text_04_02,2);


  orbitSVG.appendBubble(2.8, "images/bubble-04-03.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(2.8,[95,82],bubbleSize,bubblePosition,text_04_03,2);
  orbitSVG.appendBlock(1,
  {
    href:"images/block-04.png",
    width:75,
    height:80
  },
  "images/line-04.svg","#2d457b",bubbleSize,bubblePosition,[145,80,120],text_04_block,3)
...
var displayNodes4 = function() {
  orbitSVG.appendLine(3, "images/arc-05.svg", lineSize,linePosition);
  orbitSVG.appendBubble(3.2, "images/bubble-05-01.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });

  orbitSVG.appendText(3.22,[90,160],bubbleSize,bubblePosition,text_05_01,2);

  orbitSVG.appendBubble(3, "images/bubble-05-02.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  orbitSVG.appendText(3.01,[95,110],bubbleSize,bubblePosition,text_05_02,2);


  orbitSVG.appendBubble(2.8, "images/bubble-05-03.svg",bubbleSize,bubblePosition, function() {
    alert("clicked");
  });
  ...
  orbitSVG.appendBlock(1,
  {
    href:"images/block-05.png",
    width:70,
    height:70
  }
  ,"images/line-05.svg","#dc3319",bubbleSize,bubblePosition,[175,95,145],text_05_block,3)
};
